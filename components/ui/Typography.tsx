...
const variantStyles: Record<TypographyVariant, string> = {
  ...
  title: 'text-xl sm:text-2xl md:text-3xl lg:text-title font-semibold tracking-tight text-deep-crimson',
  subtitle: 'text-lg sm:text-xl md:text-2xl lg:text-subtitle font-semibold text-deep-crimson',
