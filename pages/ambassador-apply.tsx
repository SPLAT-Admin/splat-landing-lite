    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#851725] via-black to-black text-white min-h-screen py-20 px-4 flex justify-center items-center">
        <div className="max-w-2xl w-full">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-6 text-[#851725] drop-shadow-lg">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="grid gap-4 bg-gray-900 p-6 rounded-lg shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input type="text" name="last_name" required placeholder="Last Name" onChange={handleChange} className="p-3 rounded bg-black text-white placeholder-gray-400" />
              </div>

              <input type="text" name="preferred_name" placeholder="Preferred Name" onChange={handleChange} className="p-3 rounded bg-black text-white placeholder-gray-400" />
              <input type="date" name="dob" required onChange={handleChange} className="p-3 rounded bg-black text-white" />
              <input type="email" name="email" required placeholder="Email" onChange={handleChange} className="p-3 rounded bg-black text-white placeholder-gray-400" />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input type="text" name="city" required placeholder="City" onChange={handleChange} className="p-3 rounded bg-black text-white placeholder-gray-400" />
                <select name="state" required onChange={handleChange} className="p-3 rounded bg-black text-white">
              ...
              <input type="text" name="social_media_handles" required placeholder="Social Media Handles" onChange={handleChange} className="p-3 rounded bg-black text-white placeholder-gray-400" />
              ...
              <button type="submit" className="mt-4 bg-[#851725] hover:bg-red-800 text-white font-bold py-3 px-6 rounded-full shadow-md hover:shadow-lg transition">
                Submit Application
              </button>
