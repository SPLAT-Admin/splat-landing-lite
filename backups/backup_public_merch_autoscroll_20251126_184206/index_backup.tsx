    ...
    <div className="min-h-screen bg-neutral-950 text-acid-white p-8 space-y-10">
      <div>
        ...
        <p className="text-center text-acid-white/70">
          Curated drops, bold fits, and featured heat.
        </p>
      </div>
        ...
        <section>
          ...
          <div className="relative">
            <Button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 z-10"
            >
              <ChevronLeft />
            </Button>
            ...
            <Button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 z-10"
            >
              <ChevronRight />
            </Button>
          </div>
          ...
          {visibleProducts.map((p) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                {p.featured && (
                  <span className="text-xs text-acid-white/70 font-semibold">★ Featured</span>
                )}
              </div>
            </div>
          ))}
